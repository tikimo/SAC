...
public enum PropertiesParagraph {
    ...
    TEXT2("Kulkuvälineestä löytyy #ajotietokone, #ilmastointi ja #lohko. Niiden lisäksi varusteina ovat #keskuslukitus, #sahkoikkunat, #vakionopeus, #urheiluistuimet, #nahka, #sahkoistuimet, #kattoluukku, #pysakointitutka, #navi, #lisalammitin, #penkinlammitin ja #sisatilapistoke. "),
